...
function ChangePicWeekPromotion(props) {
    ...
    const onFinish = async (values) => {
      try {
        ...
        await API.put(ApiRouter.UpdatePicureLevelWeekPromotion + props.id, formData, {
          headers: {
...
export default ChangePicWeekPromotion