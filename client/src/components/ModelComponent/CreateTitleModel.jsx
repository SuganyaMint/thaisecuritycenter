...
function CreateTitleModel({ setIsSubmit }) {
  const [isModalOpen, setIsModalOpen] = useState(false);

  const [form] = Form.useForm();
  const onFinish = async (values) => {
    try {
      await API.post(ApiRouter.Title, {
        title: values.title,
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Input placeholder="ใส่ Sub Title" />
          </Form.Item>
...
export default CreateTitleModel;
