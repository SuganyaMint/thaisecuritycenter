...
import CreateTitleBar from "../../components/TitleBarComponent/CreateTitleBar";
import EditTitleBar from "../../components/TitleBarComponent/EditTitleBar";

function TitleBarPage() {
    ...
    useEffect(() => {
      const fetchData = async () => {
        const res = await API.get(ApiRouter.TitleBar);
    ...
    const handleDelete = async (id) => {
      try {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            const res = await API.delete(ApiRouter.TitleBar + id);
            if (res.data.status === true) {
              Swal.fire({
