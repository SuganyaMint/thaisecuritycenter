...
import EditItemInMonthPromotion from "./EditItemInMonthPromotion";

function ItemsInGroupMonthPromotion(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await API.get(
        ApiRouter.MonthPromotionItem + "/" + props.group_id
      );
  ...
  const handleDelete = async (id) => {
    ...
    Swal.fire({
      ...
      const res = await API.delete(ApiRouter.MonthPromotionItem + "/" + id);
      if (res.data.status === true) {
...
export default ItemsInGroupMonthPromotion;
