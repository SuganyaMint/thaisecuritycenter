...
function ChangePicLevelPromotion(props) {
  ...
  const onFinish = async (values) => {
    try {
      ...
      await API.put(ApiRouter.UpdatePicureLevelPromotion + props.id, formData, {
        headers: {
...
export default ChangePicLevelPromotion;
