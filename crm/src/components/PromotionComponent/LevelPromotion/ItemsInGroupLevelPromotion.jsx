...
import EditItemLevelPromotion from "./EditItemLevelPromotion";

function ItemsInGroupLevelPromotion(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await API.get(
        ApiRouter.LevelPromotionItem + "/" + props.group_id
      );
  ...
  const handleDelete = async (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const res = await API.delete(ApiRouter.LevelPromotionItem + "/" + id);
        if (res.data.status === true) {
...
export default ItemsInGroupLevelPromotion;
